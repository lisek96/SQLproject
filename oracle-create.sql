...
-- Last modification date: 2020-06-11 19:26:54.793

-- tables
-- Table: Adres
CREATE TABLE Adres (
    id_adres int  NOT NULL,
    miasto varchar2(800)  NOT NULL,
    ulica varchar2(800)  NOT NULL,
...
CREATE TABLE Klient (
    ...
    imie varchar2(800)  NOT NULL,
    nazwisko varchar2(800)  NOT NULL,
    adres_email varchar2(800)  NOT NULL,
